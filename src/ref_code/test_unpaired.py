...
def main():
    ...
    # extract all image name contain "N"
    Image_names = [i for i in Image_names if "N" in i]
    print(Image_names)
    ...
    for i in range(len(Image_names)):
        ...
        if llie_img_mode == 'single':
            ...
            util.save_img(
                normal_img, '{}/{}'.format(result_path, Image_names[i]))
            print('{}/{}/{}'.format(current_dir,result_path, Image_names[i]))
            org_path = '{}/{}/{}'.format(current_dir,result_path, Image_names[i])
            save_path = '{}/{}'.format(SAVE_DIR, Image_names[i])
            shutil.copy(org_path, save_path)
        else:
            util.save_img(
                normal_img, '{}/{}.png'.format(result_path, Image_names[i]))
            util.save_img(
